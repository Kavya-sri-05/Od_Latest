  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
        ...
        <div className="isb-nav-container">
          ...
          <ul className="isb-nav-menu">
            <li className="isb-nav-item">
              <Link to="/" className="isb-nav-link active">Home</Link>
            </li>
            <li className="isb-nav-item">
              <Link to="/contributors" className="isb-nav-link">Contributors</Link>
            </li>
            <li className="isb-nav-item">
      ...
      >
        ...
        <div className="isb-hero-content" style={{ position: 'relative', zIndex: 2 }}>
          <h1 className="isb-hero-title" style={{ marginBottom: '1rem' }}>OD Application System</h1>
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', marginTop: '2rem' }}>
            ...
            <Link 
              to="/register" 
              className="isb-btn isb-btn-secondary isb-btn-large" 
              style={{ 
                color: '#FFFFFF', 
                borderColor: '#FFFFFF',
                borderWidth: '2px',
