        ...
        <div className="isb-nav-container">
          ...
          <ul className="isb-nav-menu">
            <li className="isb-nav-item">
              <Link to="/" className="isb-nav-link">
                Home
              </Link>
            </li>
            <li className="isb-nav-item">
              <Link to="/contributors" className="isb-nav-link active">
                Contributors
              </Link>
            </li>
            <li className="isb-nav-item">
            ...
            <li className="isb-nav-item">
              <Link
                to="/register"
                className="isb-btn isb-btn-primary isb-btn-small"
              >
                Register
              </Link>
            </li>
      ...
      >
        <Contributors
          images={[
            ...
            { filename: "Deepak R.jpg", name: "Deepak R", roll: "2023103527" },
          ]}
        />
      </div>
    </div>
